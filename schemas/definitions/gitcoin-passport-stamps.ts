...
export const definition: RuntimeCompositeDefinition = {
  models: {
    GitcoinAttestation: {
      interface: true,
      implements: [],
      id: "kjzl6hvfrbw6c5nawcon8xmqyh270olex7ggbdrpam6w0rpewkn5jyybmkyc5rw",
      accountRelation: { type: "none" },
    },
    VerifiableCredentialSubject: {
      interface: true,
      implements: [],
      id: "kjzl6hvfrbw6c9gh0ai5yg309aljtju4pisp61yrdp0ydjknb0dfjuq8c270q0x",
      accountRelation: { type: "none" },
    },
    VerifiableCredentialProof: {
      interface: true,
      implements: [],
      id: "kjzl6hvfrbw6c73j1f2hikvr9fq31m1erw4ngur4g0ila46x2kbgx7g76xeom1w",
      accountRelation: { type: "none" },
    },
    VerifiableCredential: {
      interface: true,
      implements: ["kjzl6hvfrbw6c5nawcon8xmqyh270olex7ggbdrpam6w0rpewkn5jyybmkyc5rw"],
      id: "kjzl6hvfrbw6c7g1y80sexy55f9n9cmamzwmhhepw0m132hkw95ampuj1tjk3s2",
      accountRelation: { type: "none" },
    },
    GitcoinPassportStampWrapperInterface: {
      interface: true,
      implements: [],
      id: "kjzl6hvfrbw6cad3mi9wpdiicfafo54yq0e3mxv1razxrz7d6o2hx51s27d09ou",
      accountRelation: { type: "none" },
    },
    GitcoinPassportStamp: {
      interface: false,
      implements: [
        "kjzl6hvfrbw6c7g1y80sexy55f9n9cmamzwmhhepw0m132hkw95ampuj1tjk3s2",
        "kjzl6hvfrbw6c5nawcon8xmqyh270olex7ggbdrpam6w0rpewkn5jyybmkyc5rw",
      ],
      id: "kjzl6hvfrbw6c5opf51pmnkdwb96in4tyh80o9b0kf49vyxhm0vwmbbv0e43g8k",
      accountRelation: { type: "list" },
    },
    GitcoinPassportStampWrapper: {
      interface: false,
      implements: ["kjzl6hvfrbw6cad3mi9wpdiicfafo54yq0e3mxv1razxrz7d6o2hx51s27d09ou"],
      id: "kjzl6hvfrbw6c994hekitjmidbuvzeb4zv95n88sff9w5lbqlfuedzsw5oc5jlx",
      accountRelation: { type: "list" },
    },
  },
  objects: {
    ...
    GitcoinPassportStampWrapperInterface: {
      ...
      vc: {
        ...
        relation: {
          source: "document",
          model: "kjzl6hvfrbw6c7g1y80sexy55f9n9cmamzwmhhepw0m132hkw95ampuj1tjk3s2",
          property: "vcID",
        },
      },
    },
