...
export const EVM_CHAIN_CONFIG: Record<SupportedChain, EvmChain> = {
  ...
  GOERLI: {
    chainId: 5,
    rpcUrl: process.env.GOERLI_RPC_URL || "https://ethereum-goerli.publicnode.com",
    name: "Goerli",
    mainnet: false,
  },
  SEPOLIA: {
  ...
  ARBITRUM_GOERLI: {
    chainId: 421613,
    rpcUrl: process.env.ARBITRUM_GOERLI_RPC_URL || "https://arb-goerli.g.alchemy.com/v2/demo",
