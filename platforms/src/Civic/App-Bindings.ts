...
export class CivicPlatform extends Platform {
  ...
  banner = {
    ...
    cta: {
      ...
      url: "https://getpass.civic.com?scope=uniqueness,captcha,liveness&chain=polygon,arbitrum%20one,xdc,ethereum,optimism,base,avalanche&referrer=gitcoin-passport",
    },
  };
}
