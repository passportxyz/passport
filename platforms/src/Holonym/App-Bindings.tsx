  ...
  banner = {
    ...
    content: (
      <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
        ...
        <li>
          Go to <Hyperlink href="https://silksecure.net/holonym/diff-wallet/gov-id/select">Holonym's page</Hyperlink>,
          verify your ID by connecting your wallet, and follow prompts to obtain the Government ID or ePassport Proof.
        </li>
