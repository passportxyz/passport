...
import { AppContext, Platform, ProviderPayload, PlatformInfoModalTemplate, AccessTokenResult } from "../types";
...
export class BrightidPlatform implements Platform {
  ...
  //           // replace `https://app.brightid.org/link-verification/http:%2f%2fnode.brightid.org/Gitcoin/${userDid}`
  //           link: "https://app.brightid.org/link-verification/http:%2f%2fnode.brightid.org/Gitcoin",
  ...
  async handleSponsorship(): Promise<void> {
