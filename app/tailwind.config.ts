...
export default {
  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        "passport-gradient-header": "radial-gradient(ellipse 100vw 900px at 50% 50%, #fff, #E5E5E5)",
        "passport-gradient-dashboard-cta": "radial-gradient(ellipse 100vw 900px at 50% -32px, #fff, #E5E5E5)",
      },
      colors: {
