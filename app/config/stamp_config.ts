...
const CERAMIC_CACHE_ENDPOINT_V1 =
  process.env.NEXT_PUBLIC_DEV_MODE === "true"
    ? "http://localhost:8002/ceramic-cache"
    : process.env.NEXT_PUBLIC_CERAMIC_CACHE_ENDPOINT;
const CERAMIC_CACHE_ENDPOINT_V2 =
  process.env.NEXT_PUBLIC_DEV_MODE === "true"
    ? "http://localhost:8002/ceramic-cache/v2"
    : process.env.NEXT_PUBLIC_CERAMIC_CACHE_ENDPOINT_V2;
...
export const iamUrl =
  process.env.NEXT_PUBLIC_DEV_MODE === "true"
    ...
    : process.env.NEXT_PUBLIC_PASSPORT_IAM_URL || "http://localhost:80/api/";
