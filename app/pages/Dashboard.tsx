  ...
  return (
    <div className="relative col-span-full">
      <div className="col-span-full mt-2 flex flex-col xl:flex-row gap-8 relative left-0 top-0 z-10">
        <div className="col-span-full flex flex-col grow xl:flex-row gap-8 mt-0.5">
          <DashboardScorePanel className={`w-full ${useCustomDashboardPanel || "xl:w-1/4"}`} />
          {!hideHumnBranding && <HumnSeasonPanel className="w-full xl:w-1/4" />}
          {explanationPanel && <DashboardScoreExplanationPanel className="w-full xl:w-1/2" />}
        </div>
